...
// var myNumbers = [1,2,3,4,5,6,7,8] ----source
...
// console.log("Total is", getTotalofArray(myNumbers)) -above exercise 1
...
var myNumbers = [1,2,3,4,5,6,7,8]
//var answer = myNumbers.filter(function (num) {return num % 2 === 0;}); // % 2 === 0
console.log(answer)
